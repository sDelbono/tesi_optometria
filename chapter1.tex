...
\begin{figure}[h!]
	...
	\caption{Rappresentazione vie visive: a sinistra la via pretettale e collicolare, a destra la via del nucleo genicolato laterale e pretettale}{Rappresentazione vie visive: a sinistra la via pretettale e collicolare, a destra la via del nucleo genicolato laterale e pretettale}
	\label{fig:test3}
\end{figure}
